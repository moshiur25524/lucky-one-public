...
const Extra = () => {
    return (
        <div>
            ...
            <p>UseState is a kind of hook.And it is new in react library. It would be recognige as a store of an array. useState can receive two parameters. one Parameter get value and another gets function which can be updated.</p>
        </div>
    );
};
